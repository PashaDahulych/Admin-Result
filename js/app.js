(() => {
    ...
    document.addEventListener("click", (function(e) {
        const targetElement = e.target;
        if (targetElement.closest(".search-main__icon")) {
            document.documentElement.classList.add("search-open-main");
            e.preventDefault();
        } else if (!targetElement.closest(".search-main")) document.documentElement.classList.remove("search-open-main");
    }));
    function toggleMenu(event) {
        let button = event.target;
        let menu = button.parentNode.querySelector(".menu-table");
        if (menu.style.display === "none" || menu.style.display === "") menu.style.display = "block"; else menu.style.display = "none";
    }
    let buttons = document.querySelectorAll(".body-table__burger");
    buttons.forEach((function(button) {
        button.addEventListener("click", toggleMenu);
    }));
    document.addEventListener("click", (function(event) {
        let target = event.target;
        if (!target.classList.contains("body-table__burger")) buttons.forEach((function(button) {
            let menu = button.parentNode.querySelector(".menu-table");
